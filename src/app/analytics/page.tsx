...
const Page = async () => {
  ...
  return (
    <div className=" min-h-screen w-full py-12 justify-center items-center flex">
      <div className="relative w-full max-w-6xl mx-auto text-white">
        <AnalyticsDashboard avgVisitorsPerDay={avgVisitorsPerDay} amtVistiorsToday={amtVisitorsToday} timeseriesPageviews={pageviews} topCountries={topCountries}/>
      </div>
    </div>
  )
}
